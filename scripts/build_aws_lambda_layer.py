...
class LayerBuilder:
    def __init__(
        ...
        out_zip_filename=None,  # type: Optional[str]sssss
    ):
        # type: (...) -> None
    ...
    def install_python_packages(self):
        ...
        sentry_python_sdk = os.path.join(
            DIST_PATH,
            f"sentry_sdk-{SDK_VERSION}-py2.py3-none-any.whl",  # this is generated by "make dist" that is called by "make aws-lambda-layers"
        )
        subprocess.run(
            [
                "pip",
